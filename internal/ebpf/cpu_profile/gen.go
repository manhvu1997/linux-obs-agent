...
//
//go:generate go tool bpf2go -cc clang -cflags "-O2 -g -Wall -Werror -Wno-missing-declarations -D__TARGET_ARCH_x86" -tags linux -type cpu_sample_event -type cpu_count_key CpuProfile cpu_profile.bpf.c -- -I../headers
